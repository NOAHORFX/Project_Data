...
def MY_MODEL(img_height, img_width, nclasses=19):
    ...
    base_model = InceptionV3(input_tensor=shared_input, weights='imagenet', include_top=False)

    image_features = base_model.get_layer('activation_76').output
    ...
    feature_layer = base_model.get_layer('activation_44').output
